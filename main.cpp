...
int main()
{
	...
	pointLights[0] = PointLight(Light(Color::Green, 0.4f, 0.1f), glm::vec3(-4.0f, 0.0f, 0.0f), 0.3f, 0.2f, 0.1f);
	pointLightCount++;
	pointLights[1] = PointLight(Light(Color::Blue, 0.4f, 0.1f), glm::vec3(4.0f, 0.0f, 0.0f), 0.3f, 0.2f, 0.1f);
	pointLightCount++;
