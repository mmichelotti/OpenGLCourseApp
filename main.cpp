...
int main()
{
	...
	pointLights[0] = PointLight(Color::Green, glm::vec3(-4.0f, 0.0f, 0.0f), 0.4f, 0.1f,  0.3f, 0.2f, 0.1f);
	pointLightCount++;
	pointLights[1] = PointLight(Color::Blue, glm::vec3(4.0f, 0.0f, 0.0f), 0.4f, 0.1f,  0.3f, 0.2f, 0.1f);
	pointLightCount++;
